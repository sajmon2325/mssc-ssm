    ...
    private StateMachine<PaymentState, PaymentEvent> build(Long paymentId){
        ...
        sm.getStateMachineAccessor()
                .doWithAllRegions(smaccessor ->{
                    smaccessor.addStateMachineInterceptor(paymentStateChangeInterceptor);
                    smaccessor.resetStateMachine(new DefaultStateMachineContext<>(payment.getPaymentState(), null, null,null));
                });
